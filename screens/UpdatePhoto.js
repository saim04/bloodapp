...
export default function UpdatePhoto({navigation}) {
    ...
    return (
        ...
        <View style={{padding:10,marginTop:8,justifyContent:'center',alignItems:'center'}}>
            <Text style={{fontSize:20,color:'#ca191f',fontWeight:'bold'}}>Change Profile Picture</Text>
        </View>
        <View style={{}}>
            <View style={styles.profilepictureContainer}>
                { img == null ?
            ...
            <TouchableOpacity style={styles.buttonPicker} onPress={pick_img}>
             <Text style={styles.buttonText}>Open Gallery to Pick Photo.</Text>
            </TouchableOpacity>  
        </View>
